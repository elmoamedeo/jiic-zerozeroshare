...
import static br.com.cesusc.zerozeroshare.web.rest.TestUtil.sameInstant;
...
class JobResourceIT {
    ...
    void putNewJob() throws Exception {
        ...
        updatedJob.name(UPDATED_NAME).description(UPDATED_DESCRIPTION).contact(UPDATED_CONTACT).value(UPDATED_VALUE).date(UPDATED_DATE);
    ...
    void partialUpdateJobWithPatch() throws Exception {
        ...
        partialUpdatedJob.description(UPDATED_DESCRIPTION).date(UPDATED_DATE);
